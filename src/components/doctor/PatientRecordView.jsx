    ...
    <div className="h-full flex flex-col gap-6 md:flex-row bg-transparent">
      ...
      <div className="w-full md:w-1/3 flex flex-col gap-6">
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 relative overflow-hidden group">
          ...
          <div className="flex items-center gap-4 mb-6 relative z-10">
            <div className="w-20 h-20 bg-slate-100 rounded-2xl flex items-center justify-center text-slate-400 border border-slate-200 shadow-sm">
              <User size={40} />
            </div>
            <div>
              <h2 className="text-2xl font-bold text-slate-800">{patient.name}</h2>
              <div className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-emerald-50 text-emerald-700 rounded-lg text-xs font-semibold mt-2 border border-emerald-100">
      ...
      <div className="w-full md:w-2/3 flex flex-col gap-6 h-[calc(100vh-200px)] overflow-y-auto pr-2 pb-10 custom-scrollbar">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 hover:border-emerald-200 transition-colors flex flex-col items-center justify-center gap-2 cursor-pointer group">
            ...
            <span className="text-sm font-medium text-slate-700">Vitals</span>
          </div>
          <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 hover:border-emerald-200 transition-colors flex flex-col items-center justify-center gap-2 cursor-pointer group">
            ...
            <span className="text-sm font-medium text-slate-700">Write Rx</span>
          </div>
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 flex-1">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-bold text-slate-800">Recent Medical History</h3>
          ...
          <div className="space-y-6 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-200 before:to-transparent">
            ...
            <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
              ...
              <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-slate-50 hover:bg-white p-4 rounded-2xl border border-gray-100 hover:border-emerald-200 hover:shadow-md transition-all">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-xs font-bold text-emerald-600 bg-emerald-100/50 px-2 py-1 rounded-md">12 Nov 2025</span>
                  <span className="text-xs text-slate-400">Apollo Hospital</span>
                </div>
                <h4 className="font-bold text-slate-800 text-sm mb-1">Cardiology Consult</h4>
                <p className="text-sm text-slate-600 limit-lines-2 mb-3">Routine checkup for Hypertension. BP recorded 135/85. Continued current medications.</p>
            ...
            <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
              ...
              <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-slate-50 hover:bg-white p-4 rounded-2xl border border-gray-100 hover:border-blue-200 hover:shadow-md transition-all">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-xs font-bold text-blue-600 bg-blue-100/50 px-2 py-1 rounded-md">28 Oct 2025</span>
                  <span className="text-xs text-slate-400">Lal PathLabs</span>
                </div>
                <h4 className="font-bold text-slate-800 text-sm mb-1">Lipid Profile & HbA1c</h4>
                <p className="text-sm text-slate-600 mb-3">HbA1c: 6.8%. LDL: 110 mg/dL.</p>
                
                <div className="flex items-center gap-2">
                  <button className="flex items-center justify-center w-8 h-8 rounded-full bg-slate-100 text-slate-600 hover:bg-emerald-100 hover:text-emerald-700 transition-colors tooltip" title="Preview Report">
                    <Eye size={16} />
                  </button>
                  <button className="flex items-center text-xs gap-1 text-slate-500 hover:text-slate-800 font-medium">
